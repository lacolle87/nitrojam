...
function PrivacyBlock() {
  return (
    <Container>
      ...
      <h1 className={css.metatag}>1. Общие положения</h1>
      <p className={css.text}>
        ...
        предпринимаемые NITROJAM REC (далее – Оператор).
      </p>
      <p className={css.text}>
      ...
      <p className={css.text}>
        ...
        https://nitrojamrec.com/.
      </p>
      <br />
      <h1 className={css.metatag}>
      ...
      <p className={css.text}>
        ...
        сети интернет по сетевому адресу https://nitrojamrec.com/;
      </p>
      <p className={css.text}>
      ...
      <p className={css.text}>
        2.9. Пользователь – любой посетитель веб-сайта https://nitrojamrec.com/;
      </p>
      <p className={css.text}>
      ...
      <p className={css.text}>3.1.Электронный адрес;</p>
      <p className={css.text}>3.2.Номера телефонов;</p>
      <p className={css.text}>3.3.Имя;</p>
      <p className={css.text}>
      ...
      <br />
      <h1 className={css.metatag}>4. Цели обработки персональных данных</h1>
      <p className={css.text}>
      ...
      <p className={css.text}>
        ...
        почты admin@nitrojamrec.com с пометкой «Отказ от уведомлений о новых
      ...
      <p className={css.text}>
        ...
        специальные формы, расположенные на сайте https://nitrojamrec.com/.
      ...
      <p className={css.text}>
        ...
        уведомление на адрес электронной почты Оператора admin@nitrojamrec.com с
      ...
      <p className={css.text}>
        ...
        электронной почты на электронный адрес Оператора admin@nitrojamrec.com с
      ...
      <br />
      <h1 className={css.metatag}>8. Заключительные положения</h1>
      <p className={css.text}>
        ...
        Оператору с помощью электронной почты admin@nitrojamrec.com.
      </p>
      <p className={css.text}>
      ...
      <p className={css.text}>
        ...
        Интернет по адресу https://nitrojamrec.com/privacy.
      </p>
      <br />
    </Container>
  )
